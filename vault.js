  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Landing — pack selection buttons
    const btnDigital = document.getElementById('btn-digital');
    const btnPhysical = document.getElementById('btn-physical');
    if (btnDigital)  btnDigital.addEventListener('click',  () => selectPack('digital'));
    if (btnPhysical) btnPhysical.addEventListener('click', () => selectPack('physical'));
